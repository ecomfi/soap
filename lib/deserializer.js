...
@param options {DeserializationOptions} options for processing the parsed XML
...
/**
If this is true, assume the docuement is SOAP encoded
...
/**
This drives deserialization of XML into JavaScript
@class ResponseDescriptor
**/

/**
True if the XML document's style is RPC
@property isRPC
@type Boolean
**/

/**
True if the XML document's use is encoded
@property isEncoded
@type Boolean
**/

/**
The parts of the response message
@property parts
@type Array(PartDescriptorArray(TypeDescriptor))
**/


/**
Descriptor of an XML type
@class ResponseDescriptor
**/
        ...
        if (isArray) {
            ...
            if (isEncoded) {
                ...
                arr.forEach(function(row) {
                    value.push(processJsonType(jsonType, source['#']));
                });
            }
            parent[name] = value;
        }
